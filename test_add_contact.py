...
class test_add_contact(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        self.create_contact(wd, firstname="aaaaa", middlename="bbbb", lastname="cccc", nickname="ddddd", title="dddd",
                            company="eeee", address="fffff", fax="gggg", mobile="hhh", work="iii", home="gggg",
                            email="kkkk", email2="llll", email3="mmm", homepage="nnn", byear="1990", ayear="2000",
                            address2="oooo", phone2="pppp", notes="qqqq")
        self.open_home_page(wd)
        self.logout(wd)
    ...
    def create_contact(self, wd, firstname, middlename, lastname, nickname, title, company, address, fax, mobile, work,
                       home, email, email2, email3, homepage, byear, ayear, address2, phone2, notes):
