...
class test_add_contact(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        self.create_contact(wd, Contact(firstname="aaaaa", middlename="bbbb", lastname="cccc", nickname="ddddd",
                            title="dddd", company="eeee", address="fffff", fax="gggg", mobile="hhh", work="iii",
                            home="gggg", email="kkkk", email2="llll", email3="mmm", homepage="nnn", option1="3",
                            option2="3", byear="1990", option3="5", option4="6", ayear="2000", address2="oooo",
                            phone2="pppp", notes="qqqq"))
        self.open_home_page(wd)
        self.logout(wd)
    ...
    def test_add_empty_contact(self):
        ...
        self.create_contact(wd, Contact(firstname="", middlename="", lastname="", nickname="", title="",
                            company="", address="", fax="", mobile="", work="", home="",
                            email="", email2="", email3="", homepage="", option1="1", option2="1", byear="",
                            option3="1", option4="1", ayear="", address2="", phone2="", notes=""))
        self.open_home_page(wd)
        self.logout(wd)
